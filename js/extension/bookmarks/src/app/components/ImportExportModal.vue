...
<template>
    <DialogRoot :open="open" @update:open="updateOpen">
        <DialogPortal>
            ...
            <DialogContent
                class="dialog-content import-export-dialog"
                ...
                <div class="import-export-body">
                    <section class="import-export-group">
                        <div class="import-export-row">
                            ...
                            <button
                                class="button-secondary import-export-action"
                                type="button"
                                :disabled="busy"
                        ...
                        <div class="import-export-row">
                            <div class="import-export-copy">
                                ...
                                <span
                                    >按同级结构增量恢复；已有节点复用，新节点追加，并同步恢复标签、备注和界面偏好。</span
                                >
                            </div>
                            <button
                                class="button-primary import-export-action"
                                type="button"
                                :disabled="busy"
                                @click="pickFile(fullInputRef)"
                            >
                                <FileUp :size="14" />
                                <span>导入全量</span>
                            </button>
