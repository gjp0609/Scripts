...
export function useSearchOverlayPosition(options: { currentEngineId: Ref<string>; visible: Ref<boolean> }) {
    ...
    watch(() => [options.currentEngineId.value, options.visible.value], schedule, { flush: 'post' });
