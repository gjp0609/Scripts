        ...
        setInterval(async () => {
            ...
            try {
                ...
                if (studyPage) {
                    ...
                    let result = await studyPage.evaluate((answerIndex, lastOptionLength) => {
                        /**
                         * 获得指定数组的所有组合
                         */
            ...
            try {
                ...
                if (studyPage) {
                    ...
                    let result = await studyPage.evaluateHandle(() => {
                        let tips = document.querySelector('.chapter ul .posCatalog_level ul .posCatalog_select.posCatalog_active .icon_Completed.prevTips .prevHoverTips');
...
//# sourceMappingURL=chaoxing.js.map